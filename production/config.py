...
SCRIPT_SCHEMA = {
    ...
    "scene3_items":      "the pair of items that get held up together (image swap)",
    "scene3_line":       "Andy's 'you gotta keep them together because [cute non-romantic reason]' line",
